...
function renderInvoiceStatus() {
  const emailCard = document.querySelector<HTMLElement>('.email-card')
  if (!emailCard || !order.value?.invoice?.requested || emailCard.querySelector('.invoice-inline')) return
  ...
  email.textContent = order.value.invoice.email === 'correo registrado' ? order.value.buyerEmail || 'tu correo registrado' : order.value.invoice.email || 'tu correo registrado'
...
async function loadOrder() {
  ...
  } catch (error) { message.value = error instanceof Error ? error.message : 'No pudimos consultar el pedido.' } finally { await hidePaymentLoadingScreen(); isLoading.value = false; void nextTick().then(() => { renderWhatsAppSupport(); renderInvoiceStatus() }) }
}
...
.found-orders { display:none; }
.order-detail-overlay { align-items:center;background:rgba(33,30,29,.7);display:flex;inset:0;justify-content:center;padding:18px;position:fixed;z-index:1000; }.order-detail-modal { background:#fbf7f2;box-shadow:16px 16px 0 #b86f54;max-height:calc(100dvh - 36px);max-width:620px;overflow:auto;padding:38px;position:relative;width:100%; }.order-detail-close { background:transparent;border:0;color:#211e1d;cursor:pointer;font-size:30px;line-height:1;position:absolute;right:16px;top:13px; }.order-detail-modal>p { color:#b86f54;font:600 10px Arial,sans-serif;letter-spacing:.12em;margin:0; }.order-detail-modal h2 { font:600 28px Georgia,serif;letter-spacing:-.04em;margin:10px 28px 24px 0;overflow-wrap:anywhere; }.order-detail-summary { background:#211e1d;color:#fffdfa;display:flex;flex-wrap:wrap;gap:18px;padding:18px; }.order-detail-summary span { display:flex;flex:1 1 120px;flex-direction:column;gap:6px; }.order-detail-summary small { color:#f4d9d5;font:600 9px Arial,sans-serif;letter-spacing:.08em; }.order-detail-summary b { font:600 14px Arial,sans-serif; }.order-detail-items { margin-top:26px; }.order-detail-items h3 { font:600 24px Georgia,serif;margin:0 0 12px; }.order-detail-items p { border-top:1px solid #ddd0c8;display:flex;justify-content:space-between;margin:0;padding:12px 0; }.order-detail-invoice { background:#f4d9d5;font:13px/1.5 Arial,sans-serif;margin-top:20px;padding:15px; }.order-detail-invoice i { color:#b86f54;margin-right:7px; }.order-detail-done { background:#b86f54;border:0;color:#fffdfa;cursor:pointer;font:600 11px Arial,sans-serif;letter-spacing:.06em;margin-top:22px;padding:14px 18px;text-transform:uppercase;width:100%; }.detail-enter-active,.detail-leave-active { transition:opacity .2s ease }.detail-enter-from,.detail-leave-to { opacity:0 }@media (max-width:600px) { .order-detail-modal { box-shadow:8px 8px 0 #b86f54;padding:30px 22px; }.order-detail-summary { flex-direction:column;gap:13px; } }
.invoice-inline { align-items:flex-start;background:#fff6f2;border-left:4px solid #b86f54;display:flex;gap:12px;margin-top:20px;padding:15px; }.invoice-inline>i { color:#b86f54;font-size:20px;margin-top:2px; }.invoice-inline>div { display:block;min-width:0; }.invoice-inline p { color:#b86f54!important;font:600 9px Arial,sans-serif!important;letter-spacing:.1em;margin:0 0 5px!important; }.invoice-inline b { display:block;font:600 16px Georgia,serif;letter-spacing:-.02em;margin-bottom:4px; }.invoice-inline span,.invoice-inline strong { color:#5f5652;font:12px/1.45 Arial,sans-serif; }.invoice-inline strong { color:#211e1d;overflow-wrap:anywhere; }.order-detail-overlay { align-items:center;background:rgba(33,30,29,.7);display:flex;inset:0;justify-content:center;padding:18px;position:fixed;z-index:1000; }.order-detail-modal { background:#fbf7f2;box-shadow:16px 16px 0 #b86f54;max-height:calc(100dvh - 36px);max-width:620px;overflow:auto;padding:38px;position:relative;width:100%; }.order-detail-close { background:transparent;border:0;color:#211e1d;cursor:pointer;font-size:30px;line-height:1;position:absolute;right:16px;top:13px; }.order-detail-modal>p { color:#b86f54;font:600 10px Arial,sans-serif;letter-spacing:.12em;margin:0; }.order-detail-modal h2 { font-size:0;margin:10px 28px 24px 0; }.order-detail-modal h2::before { color:#071331;content:'Resumen de tu pedido';display:block;font:600 34px/.95 Georgia,serif;letter-spacing:-.05em; }.order-detail-modal h2::after { color:#766c67;content:attr(data-reference);display:block;font:500 11px 'DM Mono',monospace;letter-spacing:.02em;margin-top:10px;overflow-wrap:anywhere; }.order-detail-summary { background:#211e1d;color:#fffdfa;display:flex;flex-wrap:wrap;gap:18px;padding:18px; }.order-detail-summary span { display:flex;flex:1 1 120px;flex-direction:column;gap:6px; }.order-detail-summary small { color:#f4d9d5;font:600 9px Arial,sans-serif;letter-spacing:.08em; }.order-detail-summary b { font:600 14px Arial,sans-serif; }.order-detail-items { margin-top:26px; }.order-detail-items h3 { font:600 24px Georgia,serif;margin:0 0 12px; }.order-detail-items p { border-top:1px solid #ddd0c8;display:flex;justify-content:space-between;margin:0;padding:12px 0; }.order-detail-invoice { background:#fff6f2;border-left:4px solid #b86f54;color:#211e1d;font:13px/1.5 Arial,sans-serif;margin-top:20px;padding:15px; }.order-detail-invoice i { color:#b86f54;margin-right:7px; }.order-detail-done { background:#b86f54;border:0;color:#fffdfa;cursor:pointer;font:600 11px Arial,sans-serif;letter-spacing:.06em;margin-top:12px;padding:14px 18px;text-transform:uppercase;width:100%; }.detail-enter-active,.detail-leave-active { transition:opacity .2s ease }.detail-enter-from,.detail-leave-to { opacity:0 }:global(.order-detail-whatsapp),:global(.order-detail-full) { align-items:center!important;border-radius:0;display:flex!important;gap:13px!important;margin-top:14px;padding:15px 16px!important;text-decoration:none!important; }:global(.order-detail-whatsapp) { background:#e7f8ea!important;border:1px solid #65c979;color:#12331d!important; }:global(.order-detail-whatsapp)>i:first-child { align-items:center;background:#25d366;border-radius:50%;display:flex;font-size:18px;height:34px;justify-content:center;width:34px; }:global(.order-detail-whatsapp) span { align-items:flex-start!important;display:flex!important;flex:1;flex-direction:column!important;gap:2px!important;text-align:left!important; }:global(.order-detail-whatsapp) b { font:700 13px Arial,sans-serif!important; }:global(.order-detail-whatsapp) small { color:#346341;font:11px Arial,sans-serif!important; }:global(.order-detail-whatsapp)>i:last-child { color:#16893b;font-size:12px; }:global(.order-detail-full) { background:#fffdfa;border:1px solid #d9c5bc;color:#211e1d;font:600 11px Arial,sans-serif;justify-content:space-between;letter-spacing:.05em;text-transform:uppercase; }:global(.order-detail-full)>i { color:#b86f54; }:global(.order-detail-full):hover { background:#211e1d;color:#fffdfa; }@media (max-width:600px) { .invoice-inline { padding:13px; }.order-detail-modal { box-shadow:8px 8px 0 #b86f54;padding:30px 22px; }.order-detail-modal h2::before { font-size:29px; }.order-detail-summary { flex-direction:column;gap:13px; } }
</style>
<style scoped lang="scss">
