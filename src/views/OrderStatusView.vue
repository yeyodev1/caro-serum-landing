...
async function openFoundOrder(reference: string) {
  try {
    ...
    await nextTick()
    const title = document.querySelector<HTMLElement>('.order-detail-modal h2')
